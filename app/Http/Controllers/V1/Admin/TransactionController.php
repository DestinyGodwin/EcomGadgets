...
class TransactionController extends BaseTransactionController
{
    ...
    public function storeTransactions(TransactionFilterRequest $request, string $storeId): AnonymousResourceCollection
    {
        $filters = $request->validated();
        $transactions = $this->transactionService->getStoreTransactions($storeId, $filters);
    ...
    public function byType(TransactionFilterRequest $request, string $type)
    {
        ...
        $filters = $request->validated();
        $transactions = $this->transactionService->getTransactionsByType($transactionType, $filters);
    ...
    public function search(Request $request): AnonymousResourceCollection
    {
        ...
        $transactions = $this->transactionService->searchTransactions($request->q, $filters);
