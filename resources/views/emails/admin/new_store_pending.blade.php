...
<body>
  <div class="container">
    <div class="header">
      <h1>New Store Pending Approval</h1>
    </div>
    <div class="body">
      <h2>Hello Admin,</h2>
      <p>A new store "<strong>{{ $store->store_name }}</strong>" has been submitted by {{ $storeOwner }}.</p>
      <p>Please review and take action.</p>
      <a href="{{ $reviewUrl }}" class="cta-button">Review Store</a>
    </div>
    <div class="footer">
