...
<body>
  <div class="container">
    ...
    <div class="body">
      ...
      <p>A user has requested the product <span class="highlight">"{{ $productName }}"</span>.</p>
      <p><strong>Description:</strong> {{ $description }}</p>
      <div>
        <a href="{{ $ctaUrl }}" class="cta-button">View Product Request</a>
      </div>
      <p style="margin-top: 30px;">If you have this product in your store, you can contact the user or list it on the platform.</p>
      <p style="margin-top: 10px;">
        📧 For help, email <a href="mailto:support@strapre.com" class="highlight">support@strapre.com</a><br />
        🔒 Always access via <strong>strapre.com</strong>
      </p>
    </div>
    <div class="footer">
